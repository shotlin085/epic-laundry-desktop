...
| Finance command centre | Owner/accountant | revenue, cash, EBITDA readiness | Recharts + reconciliation model present; automated route capture complete, human review open |
...
| Customers / customer detail | Counter/owner | segments, spend, balance, timeline | Directory/detail route plus persisted order-status journey and shared empty states; automated route capture complete, customer-detail variant included in representative capture, human review open |
