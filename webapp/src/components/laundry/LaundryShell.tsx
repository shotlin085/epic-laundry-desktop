...
const navigationGroups: Array<{ id: string; label: string; items: typeof navigation }> = [
  ...
  { id: 'management', label: 'Business controls', items: navigation.filter((item) => ['/laundry/management', '/laundry/finance-setup', '/laundry/online-orders', '/laundry/marketplace-catalogue', '/laundry/sync-status', '/laundry/platform-control', '/laundry/platform-orders', '/laundry/reports', '/laundry/catalogue', '/laundry/import-prices', '/laundry/import-catalogue', '/laundry/import-customers', '/laundry/settings'].includes(item.to)) },
]
